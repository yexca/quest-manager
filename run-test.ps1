...
Invoke-QuestCommand -File 'node.exe' -Arguments @('--test', 'tests/frontend/taskState.test.ts', 'tests/frontend/installState.test.ts', 'tests/frontend/applicationState.test.ts')
